...
function convert(grade, student) {
    ...
    // {
    //     let htmlString = `<button id="cull" style="display: inline-block;">Cull.</button>`;
    //     document.getElementById("mysteriousSection").innerHTML += htmlString;
    //     document.getElementById("cull").addEventListener('click', function() {
    //         alert(`${student.first} ${student.last} has been culled.`);
    //         students.splice(magicIndex);
    //         let selectionMenu = document.getElementById('mystery');
    //         selectionMenu.removeChild(selectionMenu.value[magicIndex]);
    //         magicIndex = 0;
    //         gradeText = `= 0`;
    //         document.getElementById("mysteriousText").textContent = gradeText;
    //     });
...
>>>>>>> 6cc8be7d77737e8b4c4cd35dad394f2cd2d23d1d:week-6/ponder-1/script.js
